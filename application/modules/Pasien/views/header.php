...
<head>
    ...
    <!-- Input File -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/'; ?>assets/plugins/bootstrap-fileinput/css/fileinput.min.css" media="all">

    <!-- Cropper Image Upload-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/'; ?>assets/vendor/cropper/css/cropper.min.css">

    <!-- Fancybox -->
    <link rel="stylesheet" href="<?php echo base_url().'assets/';?>assets/plugins/fancybox/jquery.fancybox.css">

    <!-- Ecomerce -->
    <link rel="stylesheet" href="<?php echo base_url().'assets/';?>assets/css/ecommerce.css">
